...
mixin _$RankingModel {
 ...
 String get userId; String get nickname; int get totalMatches; int get wins; double get winRate;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime get updatedAt;
...
@useResult
$Res call({
 String userId, String nickname, int totalMatches, int wins, double winRate,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId,  String nickname,  int totalMatches,  int wins,  double winRate, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RankingModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId,  String nickname,  int totalMatches,  int wins,  double winRate, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _RankingModel():
return $default(_that.userId,_that.nickname,_that.totalMatches,_that.wins,_that.winRate,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId,  String nickname,  int totalMatches,  int wins,  double winRate, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _RankingModel() when $default != null:
return $default(_that.userId,_that.nickname,_that.totalMatches,_that.wins,_that.winRate,_that.updatedAt);case _:
  return null;
...
class _RankingModel implements RankingModel {
  const _RankingModel({required this.userId, required this.nickname, this.totalMatches = 0, this.wins = 0, this.winRate = 0.0, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) required this.updatedAt});
